 ...
 */
public class CourseContainsPrerequisiteTest1
{
    public static void main(String[] args) throws IllegalAccessException
    {
        ...
        String setCourse2Name = "Data - Structures";
        int setCourse2Number = 2630;
        Program setCourse2Program = Program.COMPUTER_SCIENCE;
