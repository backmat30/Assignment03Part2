 ...
 */
public class ScheduleCalculateCreditsSemesterTest1
{
    ...
    public static void main(String[] args) throws IllegalAccessException
    {
        ...
        ScheduleEntry myScheduleEntry = new ScheduleEntry(Semester.SPRING, year, newCourse);
        ScheduleEntry myScheduleEntry1 = new ScheduleEntry(Semester.SPRING, year, newCourse2);
        ...
        //Test the method
        int myCredits = mySchedule.calculateCredits(Semester.SPRING, year);
